...
@pytest.mark.parametrize("commands, input, output", [
    (["results", "import"], Helper.get_input_for_results_import_without_arguments(), Helper.get_output_for_results_import_without_arguments()),
    (["results", "upload"], Helper.get_input_for_results_upload_without_arguments(), Helper.get_output_for_results_upload_without_arguments()),
    (["testrun", "complete"], Helper.get_input_for_testrun_complete_without_arguments(), Helper.get_output_for_testrun_complete_without_arguments()),
    (["testrun", "create"], Helper.get_input_for_testrun_create_without_arguments(), Helper.get_output_for_testrun_create_without_arguments())])
def test_run_results_with_command_without_arguments(runner, commands, input, output):
    result = runner.invoke(execute, commands, input=input)
