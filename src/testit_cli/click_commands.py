...
@click.option("-u", "--url", type=str, envvar='TMS_URL', prompt="Set url", help="Set url address of the Test IT instance (https://demo.testit.software)")
@click.option("-t", "--token", type=str, envvar='TMS_TOKEN', prompt="Set API token", help="Set API token (T2lKd2pLZGI4WHRhaVZUejNl)")
@click.option("-ci", "--configuration-id", type=str, envvar='TMS_CONFIGURATION_ID', prompt="Set configuration id", help="Set configuration id (15dbb164-c1aa-4cbf-830c-8c01ae14f4fb)")
@click.option("-ti", "--testrun-id", type=str, envvar='TMS_TEST_RUN_ID', prompt="Set test run id", help="Set test run id (3802f329-190c-4617-8bb0-2c3696abeb8f)")
...
@click.option("-u", "--url", type=str, envvar='TMS_URL', prompt="Set url", help="Set url address of the Test IT instance (https://demo.testit.software)")
@click.option("-t", "--token", type=str, envvar='TMS_TOKEN', prompt="Set API token", help="Set API token (T2lKd2pLZGI4WHRhaVZUejNl)")
@click.option("-pi", "--project-id", type=str, envvar='TMS_PROJECT_ID', prompt="Set project id", help="Set project id (5236eb3f-7c05-46f9-a609-dc0278896464)")
@click.option("-ci", "--configuration-id", type=str, envvar='TMS_CONFIGURATION_ID', prompt="Set configuration id", help="Set configuration id (15dbb164-c1aa-4cbf-830c-8c01ae14f4fb)")
@click.option("-ti", "--testrun-id", type=str, envvar='TMS_TEST_RUN_ID', help="Set test run id (3802f329-190c-4617-8bb0-2c3696abeb8f)", default=None)
